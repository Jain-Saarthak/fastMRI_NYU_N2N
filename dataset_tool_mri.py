...
train_basenames=[]
valid_basenames=['file_brain_AXT1_202_2020477_0']
...
def preprocess_mri(input_files,
    ...
    for i, fn in enumerate(all_files):
        ...
        img_primal[i] = img
        print("i", i)
        print("img_primal", img_primal)
        print("img_primal[i]", img_primal[i])
        ...
        print("spec", spec)
        img_spectrum[i] = spec
        print("img_spectrum[i]", img_spectrum[i])
        print("img_spectrum", img_spectrum)
